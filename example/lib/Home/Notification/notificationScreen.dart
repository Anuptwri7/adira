                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return ListTile(
                      ...
                      onTap: () => allNotificationModel.results[index].isRead ==
                              false
                          ? OpenNotification(
                              allNotificationModel.results[index].notificationId
                                  .toString(),
                            ).whenComplete(() => allNotificationModel
                                      .results[index].notificationType ==
                                  "customer-order"
                              ? Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                          ...
                          : allNotificationModel
                                      .results[index].notificationType ==
                                  "customer-order"
                              ? Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => const CustomerOrderListScreen()))
