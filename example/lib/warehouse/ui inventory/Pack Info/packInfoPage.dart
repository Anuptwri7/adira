                        ...
                        return Container(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                  'Supplier Name: ${snapshot.data.supplierName==null?"No Supplier":snapshot.data.supplierName}',style: TextStyle(fontSize: 16,fontWeight:FontWeight.bold)),
                              Text(
                                  'Lot No: ${snapshot.data.lotNo==null?"Not a Finish Good":snapshot.data.lotNo}',style: TextStyle(fontSize: 16,fontWeight:FontWeight.bold)),
                              Row(
                                children: [
                                  Text(
                                  ...
                                  Container(
                                    ...
                                    color: Colors.indigo,
                                    child:Text("${snapshot.data.remainingQty}",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold),)
                                  )
