...
import 'package:classic_simra/warehouse/ui inventory/depratment transfer/model/requestedDepartment.dart';
import '../../../../Constants/stringConst.dart';
import '../../../../Constants/styleConst.dart';
import 'detail.dart';


class RequestedDepartmentPage extends StatefulWidget {
  const RequestedDepartmentPage({Key key}) : super(key: key);

  @override
  State<RequestedDepartmentPage> createState() => _RequestedDepartmentPageState();
}

class _RequestedDepartmentPageState extends State<RequestedDepartmentPage> {
          ...
          // ||
                      ...
                      Container(
                        ...
                        child: data[index].isPicked == false
                          ...
                          onPressed: () =>
                               goToPage(context,
                                   PickUpRequestedDetails(data[index].id)),
  ...
  Future<List<Results>> pickUpOrders(String search) async {
    ...
    final response = await http.get(
        Uri.parse('https://$finalUrl${StringConst.departmentTrasnferMaster}'),
        headers: {
    ...
    if (response.statusCode == 401) {
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        return RequestedDepartment.fromJson(jsonDecode(response.body.toString())).results;
      } else {
