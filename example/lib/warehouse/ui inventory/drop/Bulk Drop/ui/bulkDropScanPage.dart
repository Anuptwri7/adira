...
class BulkDOScanLocation extends StatefulWidget {
  ...
  BulkDOScanLocation(this.purchaseOrderDetail,this.poPackTypeCode, this.locationSavedCodes);
      ...
      finalBody.add(
          {
            ...
            "purchase_order_detail_id": widget.purchaseOrderDetail
          }
      ) ;
    }
