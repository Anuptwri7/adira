...
import 'package:classic_simra/warehouse/ui%20inventory/pick/ui/Verification/scan_pick_up.dart';
...
class PickUpVerified extends StatefulWidget {
  int id;
  PickUpVerified({Key key,  this.id}) : super(key: key);
...
class _PickUpVerifiedState extends State<PickUpVerified> {
   ...
   Future<List<OrderDetail>> pickUpVerify;
  int item;
