...
import 'package:classic_simra/warehouse/ui/Measure/finalAssignWeightPage.dart';
    ...
    return data != null
        ...
        itemBuilder: (context, index) {
          return GestureDetector(
            onTap: (){
              Navigator.push(context, MaterialPageRoute(builder: (context)=>FinalMeasurePostPage(code: data[0].puPackTypeCodes[index].code,id:widget.id.toString())));
            },
            child: Card(
