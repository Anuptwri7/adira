...
import 'package:classic_simra/warehouse/ui/Tasks/Task%20Lot%20Output/summary.dart';
...
import 'package:classic_simra/warehouse/ui/Tasks/model/lotOutput.dart';
...
class _LotOutputMasterPageState extends State<LotOutputMasterPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Lot Output Drop List"),
