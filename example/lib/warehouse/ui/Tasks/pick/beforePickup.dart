...
import 'package:classic_simra/warehouse/ui/Tasks/pick/pickTaskScan.dart';
...
import 'package:classic_simra/warehouse/ui/Tasks/model/additional.dart';

import 'getPkFromLocation.dart';
            ...
            child: GestureDetector(
              onTap: ()=>{
                data[index].picked==true?Fluttertoast.showToast(msg: "Already Picked"):goToPage(
                    context,
                 GetPackCodeFromLocation(data[index].purchaseDetail, data[index].id, data[index].qty))
              },
              child: Card(
