...
import 'package:classic_simra/warehouse/ui/drop/scanToDrop.dart';
import 'package:classic_simra/warehouse/ui/return/services/tagkeys.dart';
...
import '../../../Assets/model/serialCodes.dart';


class AssetDropSummaryPage extends StatefulWidget {
  int id;
  List SerialNo = [];
  AssetDropSummaryPage({Key key,this.id,this.SerialNo}) : super(key: key);

  @override
  State<AssetDropSummaryPage> createState() =>
      _AssetDropSummaryPageState();
}

class _AssetDropSummaryPageState extends State<AssetDropSummaryPage> {
  // String get $i => null;
                      ...
                      child: Column(
                        children: [
                          FutureBuilder(
                            ...
                            future: fetchcodesumaary(widget.id),
                            ...
                            builder:
                              ...
                              if (snapshot.hasData) {
                                ...
                                try {
                                  ...
                                  SerialCode assetsummaryrfid =
                                  SerialCode.fromJson(snapshotData);
                                            ...
                                            cells: [
                                              ...
                                              DataCell(
                                                Padding(
                                                  padding: const EdgeInsets.all(10.0),
                                                  child: Text(
                                                    assetsummaryrfid.assetDetails[index].rfidTag.code,
                                                    style: const TextStyle(
                                                        fontSize: 11,
                                                        fontWeight:
                                                        FontWeight.bold),
                                              ...
                                              DataCell(
                                                 ...
                                                 Navigator.push(
                                                          ...
                                                          rfidTag: assetsummaryrfid.assetDetails[index].rfidTag.code),
                                                      ));
                                                    },
                                                    child: Padding(
