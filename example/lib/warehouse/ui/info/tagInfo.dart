...
class TagInfo extends StatefulWidget {
  @override
  State<TagInfo> createState() => _TagInfoState();
}
...
class _TagInfoState extends State<TagInfo> {
        ...
        children: [
          ...
          rfidDocument.contains(document)
            ...
            builder: (BuildContext context, AsyncSnapshot snapshot) {
              ...
              if (snapshot.hasData) {
                try {
                  return snapshot.data['id'].toString()=="null"?Container(
                          ...
                          Padding(
                            ...
                            child: Container(
                              child:const Text(
                                "Suppplier",
                                style: TextStyle(
                                    fontFamily: 'Arial', fontSize: 15,color: Colors.black,fontWeight: FontWeight.bold),
                              ),
                            ),
                          ),
                          Padding(
                                    ...
                                    cells: [
                                      DataCell(
                                        Padding(
                                          ...
                                          child: Text(
                                           snapshot.data['asset_supplier_name'].toString(),
                                      ...
                                      DataCell(
                                          Text(
                                              ...
                                              snapshot.data['asset_category_name'].toString(),
                                            style: const TextStyle(
                                                fontSize: 12,
                                                fontWeight:
                                                FontWeight.bold),
                                    ...
                                    cells: [
                                      DataCell(
                                          Text(
                                            ...
                                            snapshot.data['purchase_cost'].toString(),
                                            style: const TextStyle(
                                                fontSize: 12,
                                                fontWeight:
                                                FontWeight.bold),
                                      ...
                                      DataCell(
                                        Padding(
                                          padding: const EdgeInsets.all(10.0),
                                          child: Text(
                                           snapshot.data['end_of_life_in_years'].toString(),
                                            style: const TextStyle(
                                                fontSize: 11,
                                                fontWeight:
                                                FontWeight.bold),
                                      ...
                                      DataCell(
                                          Text(
                                              ...
                                              snapshot.data['amc_rate'].toString(),
                                            style: const TextStyle(
                                                fontSize: 12,
                                                fontWeight:
                                                FontWeight.bold),
                                      ...
                                      DataCell(
                                          Text(
                                            ...
                                            snapshot.data['depreciation_rate'].toString(),
                                            style: const TextStyle(
                                                fontSize: 12,
                                                fontWeight:
                                                FontWeight.bold),
                                      ...
                                      DataCell(
                                          Text(
                                            ...
                                            snapshot.data['asset_current_value'].toString(),
                                            style: const TextStyle(
                                                fontSize: 12,
                                                fontWeight:
                                                FontWeight.bold),
                                    ...
                                    cells: [
                                      DataCell(
                                        Padding(
                                          padding: const EdgeInsets.all(10.0),
                                          child: Text(
                                           snapshot.data['location_code'].toString(),
                                            style: const TextStyle(
                                                fontSize: 11,
                                                fontWeight:
                                                FontWeight.bold),
  ...
  Future PackInfoGetInfo(String packCode) async {
    ...
    final response = await http.get(
      Uri.parse('https://$finalUrl${StringConst.assettagInfo +
          packCode.toString()}'
      ),
      headers: {
